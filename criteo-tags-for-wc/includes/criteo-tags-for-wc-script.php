 ...
 */
	...
	function criteo_tracking_code($order_id) {
		global $woocommerce, $user_email, $list_of_product_ids;

		$wc_criteo_tags_for_wc_settings = get_option( 'woocommerce_criteo-tags-for-wc_settings' );
		$criteo_account = $wc_criteo_tags_for_wc_settings[criteo_account];
